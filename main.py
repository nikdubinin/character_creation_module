...
def attack(char_name: str, char_class: str) -> str:
    """Производит атаку согласно выбранному классу."""
...
def defence(char_name: str, char_class: str) -> str:
    """Производит защиту согласно выбранному классу."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не смог заблокировать удар противника')


def special(char_name: str, char_class: str) -> str:
    """Производит спецумение согласно выбранному классу."""
    if char_class == 'warrior':
